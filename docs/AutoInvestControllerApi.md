...
api_instance = api_mobile.AutoInvestControllerApi(api_mobile.ApiClient(configuration))
id = 789 # int | id
...
# create an instance of the API class
api_instance = api_mobile.AutoInvestControllerApi(api_mobile.ApiClient(configuration))
auto_investment_view = api_mobile.AutoInvestmentView() # AutoInvestmentView | autoInvestmentView
