...
api_instance = swagger_client.InvestmentControllerApi(swagger_client.ApiClient(configuration))
...
api_instance = swagger_client.InvestmentControllerApi(swagger_client.ApiClient(configuration))
loan_id = 789 # int | loanId
request_body_with_amount = swagger_client.RequestBodyWithAmount() # RequestBodyWithAmount | requestBodyWithAmount
...
# create an instance of the API class
api_instance = swagger_client.InvestmentControllerApi(swagger_client.ApiClient(configuration))
filter = swagger_client.FilterOptions() # FilterOptions | filter
...
# create an instance of the API class
api_instance = swagger_client.InvestmentControllerApi(swagger_client.ApiClient(configuration))
filter_options = swagger_client.FilterOptions() # FilterOptions | filterOptions
...
# create an instance of the API class
api_instance = swagger_client.InvestmentControllerApi(swagger_client.ApiClient(configuration))
withdrawal_model = swagger_client.WithdrawalModel() # WithdrawalModel | withdrawalModel
